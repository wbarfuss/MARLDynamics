# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/Agents/00_Base.ipynb.

# %% auto 0
__all__ = ['abase']

# %% ../../nbs/Agents/00_Base.ipynb 4
import numpy as np
...
class abase(object):
    ...
    def Tss(self, 
            X:jnp.ndarray  # Joint strategy [NxZxA]
           ) -> jnp.ndarray: # Average transition Tss [ZxZ]
        """Compute average transition model `Tss`, given joint strategy `X`"""
    ...
    def Tisas(self,
              X:jnp.ndarray  # Joint strategy [NxZxA]
             ) -> jnp.ndarray:  #  Average transition Tisas [NxZxMxZ] 
        """Compute average transition model `Tisas`, given joint strategy `X`"""      
        i = 0  # agent i
        a = 1  # its action a
    ...
    @partial(jit, static_argnums=0)    
    def Ris(self,
            X:jnp.ndarray, # Joint strategy
            Risa:jnp.ndarray=None # Optional reward `Risa` [NxZxM] for speed-up
           ) -> jnp.ndarray: # Average reward `Ris` [NxZ]
        """Compute average reward `Ris`, given joint strategy `X`""" 
    ...
    def Risa(self,
             X:jnp.ndarray # Joint strategy
            ) -> jnp.ndarray:  # Average reward `Risa` [NxZxA]
        """Compute average reward `Risa`, given joint strategy `X`"""
    ...
    def Vis(self,
            X:jnp.ndarray, # Joint strategy
            Ris:jnp.ndarray=None, # Optional reward `Ris` [NxZ] for speed-up
            Tss:jnp.ndarray=None, # Optional transition `Tss` [ZxZ] for speed-up
            Risa:jnp.ndarray=None  # Optional reward `Risa` [NxZxM] for speed-up
           ) -> jnp.ndarray:  # Average state values `Vis` [NxZ]
        """Compute average state values `Vis`, given joint strategy `X`"""
        # For speed up
    ...
    def Qisa(self,
             X:jnp.ndarray, # Joint strategy
             Risa:jnp.ndarray=None, #  Optional reward `Risa` [NxZxM]
             Vis:jnp.ndarray=None, # Optional values `Vis` [NxZ] for speed-up
             Tisas:jnp.ndarray=None, # Optional transition `Tisas` [NxZxMxZ] for speed-up
            ) -> jnp.ndarray:  # Average state-action values `Qisa` [NxZxM]
