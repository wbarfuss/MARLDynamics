# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/Agents/01_StrategyBase.ipynb.

# %% auto 0
__all__ = ['strategybase']

# %% ../../nbs/Agents/01_StrategyBase.ipynb 4
import numpy as np
...
# %% ../../nbs/Agents/01_StrategyBase.ipynb 5
...
# %% ../../nbs/Agents/01_StrategyBase.ipynb 8
@patch
def zero_intelligence_policy(self:strategybase):
    """Returns strategy `Xisa` with equal action probabilities."""
    return jnp.ones((self.N, self.Z, self.M)) / float(self.M)

# %% ../../nbs/Agents/01_StrategyBase.ipynb 9
@patch
def random_softmax_policy(self:strategybase):
...
# %% ../../nbs/Agents/01_StrategyBase.ipynb 10
@patch
