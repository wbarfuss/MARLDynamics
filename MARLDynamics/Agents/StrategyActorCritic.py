# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/Agents/A01_StrategyActorCritic.ipynb.

# %% auto 0
__all__ = ['stratAC']

# %% ../../nbs/Agents/A01_StrategyActorCritic.ipynb 4
import numpy as np
...
# %% ../../nbs/Agents/A01_StrategyActorCritic.ipynb 5
class stratAC(strategybase):
    """
    Class for deterministic policy-average independent (multi-agent)
    temporal-difference actor-critic reinforcement learning in strategy space.
    """
